...
public class ClimateTrayPreferencesDialogController
    extends DefaultClimateTrayDialogController<ClimateTrayPreferences, ClimateTrayPreferencesController>
{
    ...
    {
        controller.setVersionCheckEnabled(enabled);
    }
